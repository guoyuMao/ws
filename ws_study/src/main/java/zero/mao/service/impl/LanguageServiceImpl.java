...
import com.zero.mao.service.LanguageService;
...
public class LanguageServiceImpl implements LanguageService {
    ...
    public static void main(String[] args) {
        ...
        //Endpoint :地址  ， 实现对象
        bean.setAddress("http://127.0.0.1:9999/ws/cxf/languageManager");
        ...
        System.out.println("wsdl地址:http://127.0.0.1:9999/ws/cxf/languageManager?WSDL");
    }
}
